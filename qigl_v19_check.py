"""
Q-IGL Digital Testbed v1.9 Check (Hybrid Realistic Model)
Focus: Re-verifying Hybrid advantage with higher statistics.
...
class Config:
    ...
    steps: int = 40
    dt: float = 0.05
    trajectories: int = 300 # Increased for better stats
    seed: int = 20260916
...
if __name__ == "__main__":
    ...
    print(f"Starting Hybrid Realistic Check (20 Qubits, {CFG.trajectories} trajectories)...")
